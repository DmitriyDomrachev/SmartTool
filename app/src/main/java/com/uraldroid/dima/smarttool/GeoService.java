...
import static com.uraldroid.dima.smarttool.fragment.SettingFragment.NOTIF_STATE_SETTING;
import static com.uraldroid.dima.smarttool.fragment.SettingFragment.SOUND_NOTIF_NOTE_SETTING;
import static com.uraldroid.dima.smarttool.fragment.SettingFragment.SOUND_NOTIF_STATE_SETTING;
...
public class GeoService extends Service implements
    ...
    private void createLocationRequest() {
        ...
        mLocationRequest.setInterval(getTimeUpdateInterval());
        mLocationRequest.setFastestInterval(getTimeUpdateInterval() - 1000);
        mLocationRequest.setPriority(LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
        mLocationRequest.setSmallestDisplacement(getMinDistance());
        ...
        if (state.getLat() != 0 || state.getLng() != 0) {
            geoQuery.get(i).addGeoQueryEventListener(new GeoQueryEventListener() {
                ...
                public void onKeyExited(String key) {
                    ...
                    if (!Objects.equals(prefs.getString(CURRENT_STATE, "1"), "Пользовательский")) {
    ...
    private void sendNotification(Context context, State state) {
        ...
        notifyIntent.putExtra("wifi", state.isWiFiState());
        notifyIntent.putExtra("bluetooth", state.isBluetoothState());
        notifyIntent.putExtra("media", state.getMediaSoundState());
        notifyIntent.putExtra("system", state.getSystemSoundState());
    ...
    private int getTimeUpdateInterval() {
//        SharedPreferences prefs = getSharedPreferences("myPrefs", Context.MODE_PRIVATE);
        return 1000;

//        switch (prefs.getInt(TIME_LOCATION_SETTING, 1000)) {
//
//            case 0:
//                return 60 * 1000;
//            case 1:
...
//        switch (prefs.getInt(DIST_LOCATION_SETTING, 0)) {
//            case 0:
//                return 10;
//            case 1:
//                return 20;
